...
public class School {
   ...
   public List<Student> ListofStudent;
    ...
    public void setListofStudent(Student student) {
    ...
    public School(String name, int schoolSize, int phoneNumber, String email, String address, List<Student> studentList) {
        this.Name = name;
        this.schoolSize = schoolSize;
        this.phoneNumber = phoneNumber;
        this.email = email;
